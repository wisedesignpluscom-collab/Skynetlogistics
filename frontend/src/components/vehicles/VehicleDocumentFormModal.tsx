...
import { useVehicleDocumentTypes } from '../../features/vehicleDocuments/hooks'
import { createVehicleDocumentType } from '../../features/vehicleDocuments/api'
import type { VehicleDocumentPayload } from '../../features/vehicleDocuments/api'

interface VehicleDocumentFormModalProps {
  onClose: () => void
  onSubmit: (values: VehicleDocumentPayload) => Promise<void>
}

export function VehicleDocumentFormModal({ onClose, onSubmit }: VehicleDocumentFormModalProps) {
  const { types, isLoading, reload } = useVehicleDocumentTypes()
  ...
  async function handleCreateType() {
    const created = await createVehicleDocumentType({
      name: newTypeName,
